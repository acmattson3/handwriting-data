...
DRAW_LEN,DRAW_WID=1200,200 # The size of the drawing window for prompt mode, in pixels.
TEXT_LEN,TEXT_WID=1000,100 # The size of the prompt display window, in pixels.
